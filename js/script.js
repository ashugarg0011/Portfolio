...
const bsBar = document.querySelector('.bar-bs')


//For the Skill Bars
var t1 = new TimelineLite()

t1.fromTo(htmlBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(65% - 6px)`, ease: Power4.easeout})
    .fromTo(cssBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(50% - 6px)`, ease: Power4.easeout})
    .fromTo(jsBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(30% - 6px)`, ease: Power4.easeout})
    .fromTo(bsBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(35% - 6px)`, ease: Power4.easeout})
